...
public class RefactorStep2 {
    public static void main(String[] args) {
        ...
        // ▼ ВАШ КОД ЗДЕСЬ ▼
        Predicate<String> isLong = s -> s.length() > 5;  // оставляем лямбду, так как нужна операция сравнения
        // ▲ КОНЕЦ ВАШЕГО КОДА ▲
        ...
        // ▼ ВАШ КОД ЗДЕСЬ ▼
        Function<String, String> exclaim = s -> s + "!";  // оставляем лямбду, так как нужна конкатенация
        // ▲ КОНЕЦ ВАШЕГО КОДА ▲
